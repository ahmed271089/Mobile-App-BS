...
import { listPendingFriendRequests, respondFriendRequest, FriendRequest } from '../../api/chat';
          ...
          renderItem={({ item }) => (
            <View style={styles.row}>
              <View style={styles.avatar}>
                <Text style={styles.avatarText}>{item.sender.name.slice(0, 2).toUpperCase()}</Text>
              </View>
              <View style={{ flex: 1 }}>
              ...
              <View style={styles.actions}>
                ...
                <Button variant="secondary" label="Decline" onPress={() => respond(item.id, false)} />
              </View>
            </View>
          )}
        />
